...
require_once 'ClassPurchaseSearchV3msg.php';
require_once 'ClassItemSearchMsg.php';
require_once 'ClassShowInfoMsg.php'; // form fields
$pur_search = new PurchaseSearch($con, 'pu_srch_submit', 'msg_files_PL\pu_search_msg_PL.txt', 'start_date', 'end_date', 'place', 'itm_name', 'orderby_form', 'asc', 'total_amt', 'cat_id', 'pur_id');
$item_search = new ItemSearch($con, 'it_srch_submit', 'msg_files_PL\it_search_msg_PL.txt', 'orderby_form1', 'searchby_form', 'it_srch_form', 'asc1');
$item_info = new ShowInfo($con, 'it_srch_info', 'msg_files_PL\it_search_info_PL.txt'); // info button, readme file
$purchase_info = new ShowInfo($con, 'pu_srch_info', 'msg_files_PL\pu_search_info_PL.txt'); 
?>
<div id="baner1"> 
...
<?php
//LIST CATEGORIES
$item_info->listCategories('Nazwa kategorii'); // printout header info as arg
?>
</div>
<div id="result2">
...
$item_info->listPlaces('Miejsce zakupu');
?>
...
<?php
//-------SEARCHES-----------
$purchase_info->PrintMsg();
$item_info->PrintMsg();
$pur_search->purSearch('msg_files_PL\pu_search_result_header_PL.txt');
$item_search->itemSearch('msg_files_PL\it_search_result_header_PL.txt'); // result printout header info as arg
?>
</div>
